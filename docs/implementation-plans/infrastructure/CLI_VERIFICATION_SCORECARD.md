...
| `provenant serve` shell lifecycle and health endpoints    | Rust-specific long-lived service surface; validate with top-level CLI/integration tests rather than ScanCode parity compare lanes                                                                                                                                                                                                                                                     |
